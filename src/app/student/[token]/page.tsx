      ...
      {count === 0 ? (
        ...
        <>
          {/* Sticky section label — the cards scroll underneath it, so a student
              ...
              -mx/px cancels the page gutter so the solid background spans the
              full width rather than stopping at the content edge, which is what
              hides the rows passing beneath it. The label's own pb-3 sets the gap
              to the first card. */}
